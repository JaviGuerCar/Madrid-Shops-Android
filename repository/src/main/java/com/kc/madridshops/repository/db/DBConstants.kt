...
internal object DBConstants {
    ...
    val ALL_COLUMNS = arrayOf(KEY_SHOP_DATABASE_ID, KEY_SHOP_JSON_ID, KEY_SHOP_NAME, KEY_SHOP_IMAGE_URL, KEY_SHOP_LOGO_IMAGE_URL, KEY_SHOP_ADDRESS, KEY_SHOP_URL, KEY_SHOP_DESCRIPTION, KEY_SHOP_LATITUDE, KEY_SHOP_LONGITUDE, KEY_SHOP_OPENING_HOURS)
