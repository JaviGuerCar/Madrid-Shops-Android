...
internal object DBConstants {
    ...
    // ACTIVITY Table field constants
    val KEY_ACTIVITY_DATABASE_ID = "_id"
    val KEY_ACTIVITY_JSON_ID = "ID_JSON"
    ...
    val ALL_COLUMNS = arrayOf(KEY_SHOP_DATABASE_ID, KEY_SHOP_JSON_ID, KEY_SHOP_NAME, KEY_SHOP_IMAGE_URL, KEY_SHOP_LOGO_IMAGE_URL, KEY_SHOP_ADDRESS, KEY_SHOP_URL, KEY_SHOP_DESCRIPTION_EN, KEY_SHOP_DESCRIPTION_ES, KEY_SHOP_LATITUDE, KEY_SHOP_LONGITUDE, KEY_SHOP_OPENING_HOURS_EN, KEY_SHOP_OPENING_HOURS_ES)

    val ALL_ACTIVITY_COLUMNS = arrayOf(KEY_ACTIVITY_DATABASE_ID, KEY_ACTIVITY_JSON_ID, KEY_ACTIVITY_NAME, KEY_ACTIVITY_IMAGE_URL, KEY_ACTIVITY_LOGO_IMAGE_URL, KEY_ACTIVITY_ADDRESS, KEY_ACTIVITY_URL, KEY_ACTIVITY_DESCRIPTION_EN, KEY_ACTIVITY_DESCRIPTION_ES, KEY_ACTIVITY_LATITUDE, KEY_ACTIVITY_LONGITUDE, KEY_ACTIVITY_OPENING_HOURS_EN, KEY_ACTIVITY_OPENING_HOURS_ES)

    val SQL_SCRIPT_CREATE_SHOP_TABLE = (
            "create table " + TABLE_SHOP
                    + "( "
                    + KEY_SHOP_DATABASE_ID + " integer primary key autoincrement, "
                    + KEY_SHOP_JSON_ID + " integer,"
